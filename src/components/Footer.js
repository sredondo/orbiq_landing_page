          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-text-secondary hover:text-accent-primary transition-colors">Precios</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-text-secondary hover:text-accent-primary transition-colors">Blog</a></li>
                <li><a href="#" className="text-text-secondary hover:text-accent-primary transition-colors">Documentación</a></li>
                <li><a href="#" className="text-text-secondary hover:text-accent-primary transition-colors">Tutoriales</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-text-secondary hover:text-accent-primary transition-colors">Sobre nosotros</a></li>
                <li><a href="#" className="text-text-secondary hover:text-accent-primary transition-colors">Contacto</a></li>
                <li><a href="#" className="text-text-secondary hover:text-accent-primary transition-colors">Términos</a></li>
              </ul>
            </div>
          </div>
        </div>
